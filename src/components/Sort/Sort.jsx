...
const Sort = memo(
    function Sort({ sortItems, onClickSortType, activeSortType}) {
        ...
        const togglePopup = () => {
            setActiveVisiblePopup(!activeVisiblePopup)
        }

        const handleOutsideClick = (e) => {
            const path = e.path || (e.composePath && e.composePath()) || compose(e.target)
        ...
        const selectItem = (obj) => {
            onClickSortType(obj.type, obj.order)
            setActiveVisiblePopup(false)
        }
        ...
        return (
            <div ref={sortRef} className="sort" >
                <div className="sort__label">
                    <svg className={activeVisiblePopup ? 'rotated' : ''}
                        width="10"
                        height="6"
                        viewBox="0 0 10 6"
                        fill="none"
